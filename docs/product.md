...
## UX direction
- Gesture-first where it improves speed.
- Minimal text; show labels only when they add clarity.
- Use native Android and Material 3 patterns when they are good enough.
- Avoid modal interruptions unless the action is destructive or ambiguous.
